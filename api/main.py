...
def commentary(scenario_id: str):
    # "variance" is not a scenario: it is the paragraph explaining why the
    # forecast missed, generated by the same pipeline into the same file.
    if scenario_id not in drivers.PRESETS and scenario_id != "variance":
        raise HTTPException(404, f"Unknown commentary: {scenario_id}")
