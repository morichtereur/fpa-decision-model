...
Takes the extracted historical drivers (price, volume, FX, M&A) plus a set
of explicit, visible planning assumptions for the forecast period, and
traces them through to EBITDA and free cash flow — the same separation of
reported facts vs. planning assumptions vs. calculated outputs used
throughout this portfolio.

TODO:
- load data/facts/henkel_drivers.json
